...
exports.validateCanonicalProduct = validateCanonicalProduct;
exports.validateOperationalState = validateOperationalState;
/**
 ...
 */
function validateVariant(variant, parentSku) {
    const errors = [];
...
function validateCanonicalProduct(product) {
    ...
    const retailPrice = product.variants?.[0]?.pricing?.retailPrice ?? product.price;
 ...
 */
function validateOperationalState(op) {
    const errors = [];
